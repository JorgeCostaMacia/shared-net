...
/// on a <see cref="StringValueObject"/> or any derived Value Object (e.g., <c>IpValueObject</c>, <c>EmailValueObject</c>).
/// </summary>
/// <remarks>
/// <para>
/// This exception inherits from <see cref="ValidationException"/> and is used to signal
/// a violation of the domain's business rules related to string-based Value Objects.
...
/// </para>
/// </remarks>
public class StringValueObjectValidationException : ValidationException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StringValueObjectValidationException"/> class with full context information.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StringValueObjectValidationException"/> class
    /// using only the necessary constraint information.
    /// </summary>
    /// <remarks>
    /// This constructor automatically sets the following default values:
    /// <list type="bullet">
    ///     <item><description>Code: <c>01951f3f-18de-7f25-ba72-abd5dbfff4b2</c> (Unique identifier for this exception).</description></item>
    ///     <item><description>Type: <c>StringValueObjectValidationException</c>.</description></item>
    ...
    public StringValueObjectValidationException(
        ...
        aggregateId,
        aggregateType ?? typeof(StringValueObjectValidationException).FullName ?? typeof(StringValueObjectValidationException).Name,
