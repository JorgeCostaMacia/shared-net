...
public class DateTimeValueObjectValidationException : ValidationException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DateTimeValueObjectValidationException"/> class
    /// using only the necessary constraint information.
    /// </summary>
    /// <remarks>
    /// This constructor automatically sets the following default values:
    /// <list type="bullet">
    ///     <item><description>Code: <c>01951f27-6649-7a17-8d7e-8cd7430f975c</c> (Unique identifier for this exception).</description></item>
    ///     <item><description>Type: <c>DateTimeValueObjectValidationException</c>.</description></item>
    ...
    public DateTimeValueObjectValidationException(
        ...
        aggregateId,
        aggregateType ?? typeof(DateTimeValueObjectValidationException).FullName ?? typeof(DateTimeValueObjectValidationException).Name,
