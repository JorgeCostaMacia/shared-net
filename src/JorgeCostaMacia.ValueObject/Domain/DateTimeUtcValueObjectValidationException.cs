...
public class DateTimeUtcValueObjectValidationException : ValidationException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DateTimeUtcValueObjectValidationException"/> class
    /// using only the necessary constraint information.
    /// </summary>
    /// <remarks>
    /// This constructor automatically sets the following default values:
    /// <list type="bullet">
    ///     <item><description>Code: <c>b6ac0653-0f46-4f9b-864d-c63036e2a11f</c> (Unique identifier for this exception).</description></item>
    ///     <item><description>Type: <c>DateTimeUtcValueObjectValidationException</c>.</description></item>
    ...
    public DateTimeUtcValueObjectValidationException(
        ...
        aggregateId,
        aggregateType ?? typeof(DateTimeUtcValueObjectValidationException).FullName ?? typeof(DateTimeUtcValueObjectValidationException).Name,
