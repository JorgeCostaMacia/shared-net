...
public class BoolValueObjectValidationException : ValidationException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BoolValueObjectValidationException"/> class
    /// using only the necessary constraint information.
    /// </summary>
    /// <remarks>
    /// This constructor automatically sets the following default values:
    /// <list type="bullet">
    ///     <item><description>Code: <c>01951db1-9cf8-72ba-9bea-398222a41bec</c> (Unique identifier for this exception).</description></item>
    ///     <item><description>Type: <c>BoolValueObjectValidationException</c>.</description></item>
    ...
    public BoolValueObjectValidationException(
        ...
        aggregateId,
        aggregateType ?? typeof(BoolValueObjectValidationException).FullName ?? typeof(BoolValueObjectValidationException).Name,
        aggregateCode ??
