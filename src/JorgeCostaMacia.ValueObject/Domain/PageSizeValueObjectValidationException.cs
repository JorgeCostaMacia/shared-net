...
/// on a <c>PageSizeValueObject</c>.
/// </summary>
/// <remarks>
/// <para>
/// This exception inherits from <see cref="IntValueObjectValidationException"/> and is used to signal
/// a violation of the domain's business rules specific to pagination size (e.g., page size is zero, negative, or exceeds a maximum allowed limit).
...
/// </para>
/// </remarks>
public class PageSizeValueObjectValidationException : IntValueObjectValidationException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PageSizeValueObjectValidationException"/> class with full context information.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PageSizeValueObjectValidationException"/> class from the given validation failures, applying the default error code for this type.
    /// </summary>
    /// <param name="validations">The validation failures that triggered this exception.</param>
    /// <param name="innerException">The exception that is the cause of the current exception, or null.</param>
    public PageSizeValueObjectValidationException(
