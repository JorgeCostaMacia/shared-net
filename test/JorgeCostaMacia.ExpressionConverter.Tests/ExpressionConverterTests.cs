// 'ExpressionConverter' is reached via 'Domain.' so the type/namespace clash under
// the 'JorgeCostaMacia.ExpressionConverter' namespace does not bite in test code.
using System.Linq.Expressions;

namespace JorgeCostaMacia.ExpressionConverter.Tests;
...
public class ExpressionConverterTests
{
    ...
    public void Convert_MapsPropertiesToStringValues()
    {
        ...
        Dictionary<string, string> result = Domain.ExpressionConverter.Convert(expression);
    ...
    public void ConvertBack_BuildsWorkingPredicate()
    {
        ...
        Func<Sample, bool> predicate = Domain.ExpressionConverter.ConvertBack<Sample>(dictionary).Compile();
    ...
    public void RoundTrip_ConvertThenConvertBack_Matches()
    {
        ...
        Dictionary<string, string> dictionary = Domain.ExpressionConverter.Convert(original);
        Func<Sample, bool> rebuilt = Domain.ExpressionConverter.ConvertBack<Sample>(dictionary).Compile();
