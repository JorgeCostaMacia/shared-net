...
{
    public INotUpdateException(Guid aggregateTypeId, string message, System.Exception? inner) : this(Guid.NewGuid(), aggregateTypeId, 409, DateTime.UtcNow, message, inner) { }
}