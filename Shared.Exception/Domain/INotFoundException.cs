...
{
    public INotFoundException(Guid aggregateTypeId, string message, System.Exception? inner) : this(Guid.NewGuid(), aggregateTypeId, 404, DateTime.UtcNow, message, inner) { }
}
