...
namespace Shared.ValueObject.Exception.Domain
{
    ...
    {
        public BoolValueObjectConstraintException(string property, bool value, List<string> constraints, Guid id, string message) : base(property, value, constraints, id, message)
        {
        }

        public BoolValueObjectConstraintException(string property, bool value, List<string> constraints, Guid id, string message, System.Exception inner) : base(property, value, constraints, id, message, inner)
        {
        }
