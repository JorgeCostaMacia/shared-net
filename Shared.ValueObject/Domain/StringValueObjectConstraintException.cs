...
public class StringValueObjectConstraintException : IConstraintException
{
    ...
    public StringValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("1a66f23c-17f7-40bc-b92a-de79f9b095c3"), $"{typeof(StringValueObject).Name} Constraint Exception", innerException, constraints) { }
}