...
public class UrlValueObjectConstraintException : StringValueObjectConstraintException
{
    ...
    public UrlValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("f90ac483-8190-456a-a903-2ac7cd87f010"), "UrlValueObject Constraint Exception", innerException, constraints) { }
}