...
public class IntValueObjectConstraintException : IConstraintException
{
    ...
    public IntValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("f93ef42d-4b96-4583-a55b-cad3ed54cffb"), "IntValueObject Constraint Exception", innerException, constraints) { }
}