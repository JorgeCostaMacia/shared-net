...
public class DecimalValueObjectConstraintException : IConstraintException
{
    ...
    public DecimalValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("b834c86a-d716-4063-8fd6-08af398caf37"), "DecimalValueObject Constraint Exception", innerException, constraints) { }
}