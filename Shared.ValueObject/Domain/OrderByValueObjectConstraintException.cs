...
public class OrderByValueObjectConstraintException : StringValueObjectConstraintException
{
    ...
    public OrderByValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("cb76bd2d-e350-476d-bc72-c1a70d47451d"), "OrderByValueObject Constraint Exception", innerException, constraints) { }
}