...
public class PageNumberValueObjectConstraintException : IntValueObjectConstraintException
{
    ...
    public PageNumberValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("df74e0e0-e20c-4135-b583-690f15b8ac1d"), "PageNumberValueObject Constraint Exception", innerException, constraints) { }
}