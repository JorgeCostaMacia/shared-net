...
public class FloatValueObjectConstraintException : IConstraintException
{
    ...
    public FloatValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("18bc336e-3322-40c9-a19d-e041238434b1"), "FloatValueObject Constraint Exception", innerException, constraints) { }
}