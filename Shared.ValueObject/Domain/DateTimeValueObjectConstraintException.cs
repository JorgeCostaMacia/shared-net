...
public class DateTimeValueObjectConstraintException : IConstraintException
{
    ...
    public DateTimeValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("88cd6dcb-9795-48c4-b27d-15f9c554a433"), "DateTimeValueObject Constraint Exception", innerException, constraints) { }
}