...
public class JsonValueObjectConstraintException : StringValueObjectConstraintException
{
    ...
    public JsonValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("64c55eae-817a-4591-84cb-24dc2b33e9df"), $"{typeof(JsonValueObject).Name} Constraint Exception", innerException, constraints) { }
}