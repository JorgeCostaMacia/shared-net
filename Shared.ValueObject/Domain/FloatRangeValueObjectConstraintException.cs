...
public class FloatRangeValueObjectConstraintException : IConstraintException
{
    ...
    public FloatRangeValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("13bad58b-3e41-4b31-9660-72934e5cc5da"), $"{typeof(FloatRangeValueObject).Name} Constraint Exception", innerException, constraints) { }
}