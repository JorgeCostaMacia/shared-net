...
public class BoolValueObjectConstraintException : IConstraintException
{
    ...
    public BoolValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("15289aba-b342-4d9e-8a2e-65c42876d4b4"), $"{typeof(BoolValueObject).Name} Constraint Exception", innerException, constraints) { }
}