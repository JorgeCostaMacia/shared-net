...
public class IpValueObjectConstraintException : StringValueObjectConstraintException
{
    ...
    public IpValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("e0a9bb6f-6e32-47f4-97fa-7b3ae3df67b7"), "IpValueObject Constraint Exception", innerException, constraints) { }
}