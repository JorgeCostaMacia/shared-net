...
public class ByteValueObjectConstraintException : IConstraintException
{
    ...
    public ByteValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("4390483f-5ee7-4aac-bb78-5fefa94e51f1"), $"{typeof(ByteValueObject).Name} Constraint Exception", innerException, constraints) { }
}