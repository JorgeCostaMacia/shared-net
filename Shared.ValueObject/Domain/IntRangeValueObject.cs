...
namespace Shared.ValueObject.Domain
{
    public class IntRangeValueObject : IValueObject
    {
        ...
        public static IntRangeValueObject? FromOrDefault(string? valueStart, string? valueEnd, bool validate = true) => valueStart != null && valueEnd != null && valueStart.Trim() != "" && valueEnd.Trim() != "" && valueStart.Trim() != "0" && valueEnd.Trim() != "0" ? From(valueStart, valueEnd, validate) : From();
