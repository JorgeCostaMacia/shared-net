...
public class OrderTypeValueObjectConstraintException : StringValueObjectConstraintException
{
    ...
    public OrderTypeValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("ca7099f9-0b56-4076-b24f-89f9bf173608"), $"{typeof(OrderTypeValueObject).Name} Constraint Exception", innerException, constraints) { }
}