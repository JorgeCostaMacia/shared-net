...
public class PageSizeValueObjectConstraintException : IntValueObjectConstraintException
{
    ...
    public PageSizeValueObjectConstraintException(System.Exception? innerException, IEnumerable<ValidationFailure> constraints) : base(new Guid("b2b4f1e1-caae-4813-9ebd-ddc63c527cae"), $"{typeof(PageSizeValueObject).Name} Constraint Exception", innerException, constraints) { }
}